          ...
          <div className="hidden lg:block">
            <div className="relative">
              ...
              <input
                ref={inputRef}
                type="text"
                placeholder="Search pages, entities, flows..."
        ...
        <div className={`${isApplicationMenuOpen ? "flex" : "hidden"} items-center justify-between w-full gap-4 px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none`}>
          ...
          <div className="flex items-center gap-3">
            <div className="hidden text-right sm:block">
              <p className="font-medium text-gray-800 text-theme-sm dark:text-white/90">Workspace User</p>
              <p className="text-gray-500 text-theme-xs dark:text-gray-400">{userEmail}</p>
            </div>
            <form action={logoutAction}>
              <button className="inline-flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-white/5">
                Sign out
              </button>
            </form>
          </div>
